...
const companyCustomerAuth = async (req, res, next) => {
  try {
    ...
    if (companyUserInfo === null) {
      return generalResponse(
        res,
        null,
        "You are not customer of this company.",
        "error",
        true,
        200
      );
    ...
    req.payment_customer_id = companyUserInfo.payment_customer_id;
    next();
  } catch (e) {
    return generalResponse(
      res,
...
module.exports = companyCustomerAuth;
